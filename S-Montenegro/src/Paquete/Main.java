...
class Main {
	...
	public static void main(String[] args) {
		...
		for(int r=0;r<vectModel.length;r++){
			...
			if(ax6==89){
				if(r==0){
					System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: Peugeot "+vectModel[r]+"$200.000,00");
				}
				if(r==1){
					System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: Peugeot "+vectModel[r]+"$250.000,00");
				}
				if(r==2){
					System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: Honda "+vectModel[r]+"$60.000,00");
				}
				if(r==3){
					System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: Yamaha "+vectModel[r]+" $80.500,50");
				}
			}
		}
		System.out.println("");
